        ...
        <div class="col-md-12">
            <table class='mt-4 table table-bordered'>
	            <div class="text-center lh-1 mb-2">
                    <h6 class="fw-bold">Fun Kindyland 2023</h6>
                </div>
        	</table>
            <table class="mt-4 table table-bordered">
            	...
            	<tbody>
                    ...
                    <tr>
                        <th scope="row">Activity Books(Cambridge Lesson, Reading, Writting, Counting, Singing, Speech, Creativity, Arts)
                            <pre>- Bahasa Melayu
- English
- Mathematics
- Science
...
- Mandarin</pre>
                    ...
                    <tr>
                        <th scope="row">ABACUS and worksheet</th>
                        <td>70.00</td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <th scope="row">S.T.E.A.M Activity</th>
                        <td>70.00</td>
                    </tr>
                    <tr>
                        <th scope="row">Arts & Creative workshop</th>
                        <td>100.00</td>
                    </tr>
                    <tr>
