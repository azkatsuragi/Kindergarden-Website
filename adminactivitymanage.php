  ...
  <tbody>
	...
	<?php
		...
		echo "<td><img src='uploads/".$row['n_pic']."'></td>";
			echo '<td>';
				echo "<a href = 'adminmodifyactivity.php?id=".$row['n_id']."' class = 'btn btn-warning'>Update</a> &nbsp";

				echo "<a onClick=\" javascript:return confirm('Are you sure to delete this?');\" href = 'activitydelete.php?id=".$row['n_id']."' class = 'btn btn-danger'>Delete</a>";
			echo '</td>';
			echo '</tr>';
		}
